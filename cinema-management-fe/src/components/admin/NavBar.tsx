...
const NavigationBar: React.FC<NavigationBarProps> = ({
  ...
  return (
    <div className="fixed top-[48px] left-0 z-[999] h-[calc(100vh-48px)] w-56 flex flex-col items-start bg-white">
      ...
      <div className="relative flex flex-col py-3 pl-[20px] w-full box-border overflow-hidden h-[72%] min-h-[316px]">
      ...
      <div className="notification-box relative flex justify-center items-center w-full h-[12%]">
        {React.Children.map(notificationChildren, (child, index) =>
          React.cloneElement(child as React.ReactElement, { key: index })
        )}
      </div>
      <div className="relative flex flex-col py-2 pl-[20px] w-full box-border overflow-hidden h-[16%] min-h-[100px]">
